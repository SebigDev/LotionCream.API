...
namespace LotionCream.API.Migrations
{
    ...
    [Migration("20180811083519_update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LotionCream.API.Actions.ShareType", b =>
                {
                    ...
                    b.Property<string>("ShareTypeName");

                    b.HasKey("ShareTypeID");
            ...
            modelBuilder.Entity("LotionCream.API.Actions.ShareType", b =>
                {
                    b.HasOne("LotionCream.API.Models.Comments.Comment")
                        .WithMany("ShareType")
                        .HasForeignKey("CommentID");

                    b.HasOne("LotionCream.API.Models.Posts.Post")
                        .WithMany("ShareType")
                        .HasForeignKey("PostID");

                    b.HasOne("LotionCream.API.Models.Replies.Reply")
                        .WithMany("ShareType")
